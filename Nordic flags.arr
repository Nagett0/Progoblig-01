...
# Lager funksjon for å kunne tegne de forsklellige nordiske flaggene
fun draw-nordic-flags(bakgru-hori, bakgru-verti, tjukk-stripe, tynn-stripe, farge-bakg, stor-farge, liten-farge) -> Image:
  ...
  # Frame for å få en ramme rundt flaggene. Så er det overlay for å slå sammen de enkelte delene/bildene av flagget samt utregning for at stripene skal være nøyaktig på plass.
...
# Definerer proposjonene, lengde, høyde, tykkelse på en tjukke stripen og den tynne stripen inkludert fargene
